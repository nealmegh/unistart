var invoiceList = $('#invoice-list').DataTable({
    ...
    headerCallback:function(e, a, t, n, s) {
        //type="checkbox" class="new-control-input chk-parent select-customers-info" id="customer-all-info"
        // e.getElementsByTagName("th")[0].innerHTML='<label class="new-control new-checkbox checkbox-primary m-auto">\n<input type="checkbox" class="invoice_id" id="invoice_id" name="invoice_id[]" value="{{$invoice->id}}">\n<span class="new-control-indicator"></span><span style="visibility:hidden">c</span>\n</label>'
    },
    // columnDefs:[ {
    //     targets:0,
    //     width:"30px",
