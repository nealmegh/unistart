...
{{--                    </li>--}}
                    ...
                    <li class="menu">
                        <a href="{{route('admin.user.users')}}" data-active="{{ (Request::route()->getPrefix() == 'admin/users') ? 'true' : 'false' }}" aria-expanded="{{ (Request::route()->getPrefix() == 'admin/users') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                                <span>Users</span>
                            </div>
                    ...
                    <li class="menu">
                        <a href="{{route('admin.categories.index')}}" data-active="{{ (Request::route()->getPrefix() == 'admin/categories') ? 'true' : 'false' }}" aria-expanded="{{ (Request::route()->getPrefix() == 'admin/categories') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                    ...
                    @can('Student')
                            <li class="menu">
                                <a href="#dashboard" data-active="{{ (Request::route()->getPrefix() == '/student') ? 'true' : 'false' }}" data-toggle="collapse" aria-expanded="{{ (Request::route()->getPrefix() == '/student') ? 'true' : 'false'}}" class="dropdown-toggle {{ (Request::route()->getPrefix() == '/student') ? '' : 'collapsed' }}">
                                    <div class="">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
                                        <span>Dashboard</span>
                                    </div>
                                ...
                                <ul class="collapse submenu list-unstyled {{ (Request::route()->getPrefix() == '/admin') ? 'show' : '' }}" id="dashboard" data-parent="#accordionExample">
                                    ...
                                    <li class="{{ (Route::currentRouteName() == 'student.dashboard') ? 'active' : '' }}">
                                        <a href="{{ route('student.dashboard') }}"> Overview </a>
                                    </li>
                            ...
                            <li class="menu">
                                <a href="{{route('student.universities')}}" data-active="{{ (Request::route()->getPrefix() == 'admin/universities') ? 'true' : 'false' }}" aria-expanded="{{ (Request::route()->getPrefix() == 'admin/universities') ? 'true' : 'false' }}" class="dropdown-toggle">
                                    <div class="">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                                        <span>Universities</span>
                                    </div>
                            ...
                            <li class="menu">
                                <a href="{{route('student.admissions')}}" data-active="{{ (Request::route()->getPrefix() == 'admin/admissions') ? 'true' : 'false' }}" aria-expanded="{{ (Request::route()->getPrefix() == 'admin/admissions') ? 'true' : 'false' }}" class="dropdown-toggle">
                                    <div class="">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                            ...
                            <li class="menu">
                                <a href="{{route('student.courses')}}" data-active="{{ (Request::route()->getPrefix() == 'student/courses') ? 'true' : 'false' }}" aria-expanded="{{ (Request::route()->getPrefix() == 'admin/courses') ? 'true' : 'false' }}" class="dropdown-toggle">
                                    <div class="">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                                        <span>Course</span>
                                    </div>
                            ...
                            <li class="menu">
                                <a href="{{route('student.choose.test')}}" data-active="{{ (Request::route()->getPrefix() == 'student/choose') ? 'true' : 'false' }}" aria-expanded="{{ (Request::route()->getPrefix() == 'student/choose') ? 'true' : 'false' }}" class="dropdown-toggle">
                                    <div class="">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                            ...
                            <li class="menu">
                                <a href="{{route('student.mocktest.review')}}" data-active="{{ (Request::route()->getPrefix() == 'student/MockTest') ? 'true' : 'false' }}" aria-expanded="{{ (Request::route()->getPrefix() == 'student/MockTest') ? 'true' : 'false' }}" class="dropdown-toggle">
                                    <div class="">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                    ...
                    @endcan
                        @can('Teacher')
                            <li class="menu">
                                <a href="#dashboard" data-active="{{ (Request::route()->getPrefix() == '/teacher') ? 'true' : 'false' }}" data-toggle="collapse" aria-expanded="{{ (Request::route()->getPrefix() == '/teacher') ? 'true' : 'false'}}" class="dropdown-toggle {{ (Request::route()->getPrefix() == '/teacher') ? '' : 'collapsed' }}">
                                    <div class="">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
                                        <span>Dashboard</span>
                                    </div>
                                ...
                                <ul class="collapse submenu list-unstyled {{ (Request::route()->getPrefix() == '/admin') ? 'show' : '' }}" id="dashboard" data-parent="#accordionExample">
                                    ...
                                    <li class="{{ (Route::currentRouteName() == 'teacher.dashboard') ? 'active' : '' }}">
                                        <a href="{{ route('teacher.dashboard') }}"> Overview </a>
                                    </li>
                            ...
                            <li class="menu">
                                <a href="{{route('teacher.courses')}}" data-active="{{ (Request::route()->getPrefix() == 'teacher/courses') ? 'true' : 'false' }}" aria-expanded="{{ (Request::route()->getPrefix() == 'teacher/courses') ? 'true' : 'false' }}" class="dropdown-toggle">
                                    <div class="">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                                        <span>Courses</span>
                                    </div>
