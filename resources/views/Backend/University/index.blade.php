            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    ...
                    <div class="col 12 button-holder" style="display: flex">
                        ...
                        <a href="{{route('admin.universities.create')}}" class="create-button-btn btn btn-success mb-6 mr-4 btn-lg"> Create</a>
                        </div>
                    </div>
                    <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                        ...
                        @foreach($universities as $university)
                            <tr>
                                ...
                                <td>{{$university->uri}}</td>
                                <td><a href="{{'mailto:'.$university->email}}">{{$university->email}}</a><br>
                                    <a href="{{'tel:'.$university->phone}}">{{$university->phone}}</a> <br>
                                    {{$university->address}}
                                </td>
