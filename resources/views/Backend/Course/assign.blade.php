                        ...
                        <div class="widget-header">
                            <div class="row">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <h2><small>assign</small> Teacher to {{$course->title}}</h2>
                                </div>
                            </div>
                        </div>
                        <div class="widget-content widget-content-area">
                            <form class="" method="post" action="{{route('admin.courses.assign.store', $course->id)}}">
                                @csrf
                                <div class="form-row mb-4" style="margin-bottom: 0px !important;">
                                    <label for="teacher_id">Teacher</label>
                                    <select id="teacher_id" class="form-control userDriver" name="teacher_id">
