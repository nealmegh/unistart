            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    ...
                    <div class="col 12 button-holder" style="display: flex">
                        ...
                        <a href="{{route('admin.categories.create')}}" class="create-button-btn btn btn-success mb-6 mr-4 btn-lg"> Create</a>
                        </div>
                    </div>
                        ...
                        @foreach($categories as $category)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a id="{{$category->id}}" class="btn btn-danger delete-car" data-value="{{$category->name}}" onClick="destroy_car({{$category->id}} )">
