            ...
            <div id="flActionButtons" class="col-lg-12">
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        <form class="" method="post"  action="{{route('cars.update', $car->id )}}">
                            @csrf
                            <div class="form-group mb-4">
                                <label class="control-label">Name:</label>
                                <input  value="{{$car->name}}" id="name" name="name" placeholder="Car Type" required="required" type="text" class="form-control" >
                            </div>
                            <div class="form-group mb-4">
                                <label class="control-label">Number of Passengers <span class="required">*</span></label>
                                <input value="{{$car->size}}" type="number" id="size" name="size" placeholder="Maximum number of Passengers can Travel" data-validate-minmax="1,20" required="required" class="form-control" >

                            </div>
                            <div class="form-group mb-4">
                                <label class="control-label" for="luggage">Number of Luggage<span class="required">*</span></label>
                                <input value="{{$car->luggage}}" type="number" id="luggage" name="luggage" placeholder="Maximum number of Luggage" required="required" class="form-control" >
                            </div>
                            <div class="form-group mb-4">
                                <label class="control-label" for="fair">Fair plus<span class="required">*</span></label>
                                <input value="{{$car->fair}}" type="number" id="fair" name="fair" placeholder="Fair to be Added" required="required" class="form-control" >
                            </div>
                            <div class="form-group mb-4">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <textarea id="description" required="required" name="description" class="form-control">{{$car->description}}</textarea>
                            </div>
