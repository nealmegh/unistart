                        ...
                        <div class="widget-header">
                            <div class="row">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <h2><small>edit</small> Teacher </h2>
                                </div>
                            </div>
                        </div>
                        <div class="widget-content widget-content-area">
                            <form class="" method="post" action="{{route('admin.teachers.update', $teacher->id)}}">
                                @csrf
                                <div class="form-row mb-4" style="margin-bottom: 0px !important;">

                                    <label for="name">NAME<span class="required">*</span></label>
                                    <input id="name" name="name" value="{{old('name', $teacher->user?->name)}}"  type="text" class="form-control" placeholder="name ">
                                ...
                                <div class="form-row mb-4" style="margin-bottom: 0px !important;">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="phone" name="phone" value="{{old('phone', $teacher->phone)}}"  type="text" class="form-control" placeholder="Phone ">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="email">EMAIL<span class="required">*</span></label>
                                        <input id="email" name="email" type="text" value="{{old('email', $teacher->user?->email)}}"  class="form-control" placeholder="Email">
                                    </div>
                                </div>
{{--                                <div class="form-row mb-4" style="margin-bottom: 0px !important;">--}}
{{--                                    <div class="form-group col-md-6">--}}
...
{{--                                </div>--}}
                                ...
                                <div class="form-row mb-4" style="margin-bottom: 0px !important;">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="education_subject" name="education_subject" value="{{old('phone', $teacher->education_subject)}}" type="text" class="form-control" placeholder="">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="training_subject">TRAINING SUBJECT</label>
                                        <input id="training_subject" name="training_subject" value="{{old('phone', $teacher->training_subject)}}" type="text" class="form-control" placeholder="">
                                    </div>
                                </div>
                                <div class="form-row mb-4" style="margin-bottom: 0px !important;">
                                    <div class="form-group col-md-6">
                                        <label for="current_occupation">CURRENT OCCUPATION</label>
                                        <input id="current_occupation" name="current_occupation" value="{{old('phone', $teacher->current_occupation)}}" type="text" class="form-control" placeholder="">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="hsc_year">HSC YEAR</label>
                                        <input id="hsc_year" name="hsc_year" type="text" value="{{old('phone', $teacher->hsc_year)}}" class="form-control" placeholder="">
                                    </div>
                                </div>
