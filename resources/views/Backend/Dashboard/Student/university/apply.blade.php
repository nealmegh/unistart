                        ...
                        <div class="widget-header">
                            <div class="row">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <h2><small>Apply to</small> {{$university->name}} </h2>
                                </div>
                            </div>
                        </div>
                        <div class="widget-content widget-content-area">
                            <form class="" method="post" action="{{route('student.admission.apply.store', [$student->id, $university->id])}}">
                                @csrf
                                <div class="form-row mb-4" style="margin-bottom: 0px !important;">

                                    <label for="name">NAME<span class="required">*</span></label>
                                    <input id="name" name="name" value="{{old('name') ?? $student->user?->name}}"  type="text" class="form-control" placeholder="name ">
                                ...
                                <div class="form-row mb-4" style="margin-bottom: 0px !important;">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="phone" name="phone" value="{{$student->phone}}" type="text" class="form-control" placeholder="Phone ">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="email">EMAIL<span class="required">*</span></label>
                                        <input id="email" name="email" type="text" value="{{old('email') ?? $student->user?->email}}" class="form-control" placeholder="Email">
                                    </div>
                                </div>
                                ...
                                <div class="form-row mb-4" style="margin-bottom: 0px !important;">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="father_name" name="father_name" value="{{$student->father_name}}" type="text" class="form-control" placeholder="">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="mother_name">MOTHER'S NAME</label>
                                        <input id="mother_name" name="mother_name" value="{{$student->mother_name}}" type="text" class="form-control" placeholder="">
                                    </div>
                                </div>
                                <div class="form-row mb-4" style="margin-bottom: 0px !important;">
                                    <div class="form-group col-md-4">
                                        <label for="ssc_result">SSC RESULT</label>
                                        <input id="ssc_result" name="ssc_result" value="{{$student->ssc_result}}" type="text" class="form-control" placeholder="">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="ssc_year">SSC YEAR</label>
                                        <input id="ssc_year" name="ssc_year" type="text" value="{{$student->ssc_year}}" class="form-control" placeholder="">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="ssc_board">SSC BOARD</label>
                                        <input id="ssc_board" name="ssc_board" value="{{$student->ssc_board}}" type="text" class="form-control" placeholder="">
                                    </div>
                                </div>
                                <div class="form-row mb-4" style="margin-bottom: 0px !important;">
                                    <div class="form-group col-md-4">
                                        <label for="hsc_result">HSC RESULT</label>
                                        <input id="hsc_result" name="hsc_result" type="text" value="{{$student->hsc_result}}" class="form-control" placeholder="">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="hsc_year">HSC YEAR</label>
                                        <input id="hsc_year" name="hsc_year" type="text" value="{{$student->hsc_year}}" class="form-control" placeholder="">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="hsc_board">HSC BOARD</label>
                                        <input id="hsc_board" name="hsc_board" type="text" value="{{$student->hsc_board}}" class="form-control" placeholder="">
                                    </div>
                                </div>

                                <div class="form-row mb-4" style="margin-bottom: 0px !important;">
                                    <label for="present_address">PRESENT ADDRESS</label>
                                    <input id="present_address" name="present_address" value="{{$student->present_address}}" type="text" class="form-control" placeholder="">
                                </div>
                                <div class="form-row mb-4" style="margin-bottom: 0px !important;">
                                    <label for="permanent_address">PERMANENT ADDRESS</label>
                                    <input id="permanent_address" name="permanent_address"value="{{$student->permanent_address}}" type="text" class="form-control" placeholder="">
                                </div>
                                <div class="form-row " style="margin-bottom: 0px !important;">
                                    <div class="form-group col-md-12">
                                        <label for="selectFrom">Subject</label>
                                        <select id="selectFrom" name="subject" class="form-control selectFrom" required="required">
