...
@section('main-content')
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <p> Thank you for {{$student->user->name}} for applying in the {{$university->name}}.
            <br>
            Your Admission ID is {{$admission->admission_test_id}}
            <br>
             Your Admission Test Date is {{$admission->admission_test_date}}
            <br>
             We will contact you with more details in your email address {{$student->user->email}}.
            </p>
        </div>
    </div>
