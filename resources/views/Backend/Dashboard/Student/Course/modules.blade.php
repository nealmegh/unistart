...
{{--                            <a href="{{route('teacher.courses.modules.create', $course->id)}}" class="create-button-btn btn btn-success mb-6 mr-4 btn-lg"> Create</a>--}}
{{--                        </div>--}}
                    </div>
                    <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                        ...
                        @foreach($modules as $module)
                            <tr>
                                <td>{{$module->name}}</td>
                                <td>
                                                                        <a href="{{route('student.courses.modules.view', [$course->id, $module->id])}}" class="btn btn-primary">
                                                                            <i class="far fa-eye"></i> view
                                                                        </a>

{{--                                    <a id="{{$module->id}}" class="btn btn-danger delete-car" data-value="{{$module->name}}" onClick="destroy_car({{$module->id}} )">--}}
    ...
    <script>
        ...
        function destroy_car(car_id) {
            ...
            swalWithBootstrapButtons({
                ...
                preConfirm: ()=>{
                    $.ajax({
                        url: '/teacher/modules/delete/'+car_id,
                        method: 'POST',
